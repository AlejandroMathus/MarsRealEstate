MarsRealEstate - Solution Code
===================================

This app is the solution code for Android Kotlin Fundamentals bootcamp: Mars Real Estate
...
with the SafeArgs plugin for parameter passing between fragments and RecyclerView.
